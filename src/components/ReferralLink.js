            ...
            <div><br />
                <div className="row">
                    ...
                    <div className="col-xl-6" style={colStyle}>
                        ...
                        <div className="col-xl-6" style={{ marginTop: "-18px", backgroundImage: "linear-gradient(to bottom, #474708, black)", borderRadius: "5px", color: "white", textAlign: "center", fontWeight: "bold", fontSize: "24px" }}>
