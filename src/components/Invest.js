            ...
            <div><br />
                <div className="row">
                    ...
                    <div className="col-xl-6" style={colStyle}>
                        ...
                        <div style={{ marginTop: "-18px", backgroundImage: "linear-gradient(to right, black, #474708)", borderRadius: "5px", color: "white", textAlign: "center", fontWeight: "bold", fontSize: "19px", }}>
                            Staking Section</div>
